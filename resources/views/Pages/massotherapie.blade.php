...
@section('content')
    ...
    <section id="massage-therapeutique" class="w-full pt-1 mt-[15vh] pb-20 xs:pb-5 xs:min-h-[50vh] xs:mt-[6vh] sm:mt-[10vh] md:mt-[15vh]">
        <div class="w-5/6 mx-auto">
            <h1 class="font-[300] text-6xl mt-10 xs:text-sm xs:mb-14 md:text-2xl lg:text-3xl">Massothérapie</h1>
    ...
    <section id="massage-relaxant" class="w-full pt-1 bg-[#f5fafd] pb-20 xs:pb-5 xs:min-h-[50vh]">
        <div class="w-5/6 mx-auto">
            <div class="w-full grid grid-rows-1 grid-cols-1 gap-x-8 xs:my-5 xs:grid-cols-1 xs:gap-y-5 sm:grid-cols-1 md:my-32">
                <div>
                    <p class="text-4xl font-semibold mb-5 text-[#03a9f4] xs:text-sm sm:text-xl md:text-xl">2. Massage relaxant</p>
                    <p class="text-[16px] text-[#477180] leading-[1.6] xs:text-[14px] sm:text-[11px] md:text-[14px] lg:text-[16px]">Le massage relaxant est une pratique douce et apaisante qui vise à procurer une profonde sensation de bien-être, tant physique que mental. Il repose sur des mouvements fluides et harmonieux tels que l’effleurage, le pétrissage, les pressions légères et les étirements, effectués avec un rythme lent et régulier. Ces techniques permettent de relâcher les tensions musculaires accumulées, d'apaiser les douleurs légères et de stimuler la circulation sanguine, favorisant ainsi une meilleure oxygénation des tissus et l’élimination des toxines.</p>
                    <p class="text-[16px] text-[#477180] leading-[1.6] xs:text-[14px] sm:text-[11px] md:text-[14px] lg:text-[16px]">Ce type de massage est idéal pour réduire le stress et l’anxiété, en aidant le corps et l’esprit à atteindre un état de relaxation profonde. Il agit également sur le système nerveux en diminuant la production de cortisol, l’hormone du stress, et en favorisant la libération d’endorphines, les hormones du bien-être.</p>
                    <p class="text-[16px] text-[#477180] leading-[1.6] xs:text-[14px] sm:text-[11px] md:text-[14px] lg:text-[16px]">En plus de ses bienfaits immédiats, le massage relaxant contribue à améliorer la qualité du sommeil, à renforcer le système immunitaire et à rétablir un équilibre émotionnel. Il s’adresse à toutes les personnes souhaitant s’accorder un moment de détente et de soin, dans un cadre calme et serein. Réalisé par un professionnel, ce massage constitue une véritable pause bien-être, permettant de retrouver énergie et sérénité au quotidien.</p>
                    <button class="text-white bg-[#03a9f4] px-8 py-4 block m-auto mt-[15%] hover:bg-cyan-700 xs:text-[14px] sm:text-[11px] xs:px-5 xs:py-2 xs:mt-[10%] md:text-[14px] lg:text-[16px]"><a class="text-decoration-none" href="{{ route('contact') }}">Contactez-nous</a></button>
                </div>
            </div>
        </div>
    ...
    <section id="massage-anti-stress" class="w-full pt-1 bg-[#f5fafd] pb-20 xs:pb-5 xs:min-h-[50vh]">
        <div class="w-5/6 mx-auto">
            <div class="w-full grid grid-rows-1 grid-cols-1 gap-x-8 xs:my-5 xs:grid-cols-1 xs:gap-y-5 sm:grid-cols-1 md:my-32">
                <div>
                    <p class="text-4xl font-semibold mb-5 text-[#03a9f4] xs:text-sm sm:text-xl md:text-xl">4. Massage anti-stress (Trigger Point)</p>
                    <p class="text-[16px] text-[#477180] leading-[1.6] xs:text-[14px] sm:text-[11px] md:text-[14px] lg:text-[16px]">Le massage anti-stress (Trigger Point) est une technique spécialisée qui se concentre sur les points de tension localisés dans les muscles, également appelés « points gâchettes ». Ces zones de tension sont souvent responsables de douleurs musculaires persistantes, de raideurs ou de sensations d’inconfort irradiant dans d'autres parties du corps.</p>
                    <p class="text-[16px] text-[#477180] leading-[1.6] xs:text-[14px] sm:text-[11px] md:text-[14px] lg:text-[16px]">Ce type de massage utilise des pressions ciblées et soutenues, appliquées directement sur les points de tension, afin de dénouer les « nœuds » musculaires profonds. Ces tensions accumulées, souvent causées par le stress, une mauvaise posture ou un effort physique excessif, peuvent engendrer des douleurs chroniques ou des restrictions de mobilité. En relâchant ces points spécifiques, le massage Trigger Point permet de restaurer la souplesse musculaire et de réduire significativement les douleurs articulaires et musculaires.</p>
                    <p class="text-[16px] text-[#477180] leading-[1.6] xs:text-[14px] sm:text-[11px] md:text-[14px] lg:text-[16px]">En plus de ses effets thérapeutiques, ce massage offre une détente profonde et aide à réduire considérablement le stress. Il agit également sur le système nerveux en apaisant les tensions psychologiques, ce qui favorise un bien-être global. Adapté aux personnes sujettes à des douleurs chroniques, à des troubles liés au stress ou simplement à un besoin de relaxation intense, le massage anti-stress est une méthode efficace pour rééquilibrer le corps et l’esprit.</p>
                    <p class="text-[16px] text-[#477180] leading-[1.6] xs:text-[14px] sm:text-[11px] md:text-[14px] lg:text-[16px]">Réalisé par un professionnel expérimenté, il s’inscrit parfaitement dans une démarche de soin visant à améliorer la qualité de vie et à retrouver un état de sérénité durable.</p>
                    <button class="text-white bg-[#03a9f4] px-8 py-4 block m-auto mt-[15%] hover:bg-cyan-700 xs:text-[14px] sm:text-[11px] xs:px-5 xs:py-2 xs:mt-[10%] md:text-[14px] lg:text-[16px]"><a class="text-decoration-none" href="{{ route('contact') }}">Contactez-nous</a></button>
                </div>
            </div>
        </div>
