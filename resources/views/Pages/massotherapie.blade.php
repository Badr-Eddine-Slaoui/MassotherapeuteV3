...
@section('content')
    ...
    <section id="massage-therapeutique" class="w-full pt-1 mt-[15vh] pb-20 xs:pb-5 xs:min-h-[50vh] xs:mt-[6vh] sm:mt-[10vh] md:mt-[15vh]">
        <div class="w-5/6 mx-auto">
            ...
            <div class="w-full grid grid-rows-1 grid-cols-1 gap-y-32 gap-x-8 xs:my-5 xs:flex xs:flex-col-reverse xs:gap-y-5 sm:grid sm:grid-cols-1 md:my-32">
                <div>
                    <p class="text-4xl font-semibold mb-5 xs:text-sm sm:text-xl md:text-xl xs:mb-2">Massage thérapeutique</p>
    ...
    <section id="massage-relaxant" class="w-full pt-1 bg-[#f5fafd] pb-20 xs:pb-5 xs:min-h-[50vh]">
        <div class="w-5/6 mx-auto">
            <div class="w-full grid grid-rows-1 grid-cols-1 gap-x-8 xs:my-5 xs:grid-cols-1 xs:gap-y-5 sm:grid-cols-1 md:my-32">
                <div>
                    <p class="text-4xl font-semibold mb-5 xs:text-sm sm:text-xl md:text-xl">Massage relaxant</p>
    ...
    <section id="massage-sportif" class="w-full pt-1 pb-20 xs:pb-5 xs:min-h-[50vh]">
        <div class="w-5/6 mx-auto">
            <div class="w-full grid grid-rows-1 grid-cols-1 gap-y-32 gap-x-8 xs:my-5 xs:flex xs:flex-col-reverse xs:gap-y-5 sm:grid sm:grid-cols-1 md:my-32">
                <div>
                    <p class="text-4xl font-semibold mb-5 xs:text-sm sm:text-xl md:text-xl xs:mb-2">Massage sportif</p>
    ...
    <section id="massage-anti-stress" class="w-full pt-1 bg-[#f5fafd] pb-20 xs:pb-5 xs:min-h-[50vh]">
        <div class="w-5/6 mx-auto">
            <div class="w-full grid grid-rows-1 grid-cols-1 gap-x-8 xs:my-5 xs:grid-cols-1 xs:gap-y-5 sm:grid-cols-1 md:my-32">
                <div>
                    <p class="text-4xl font-semibold mb-5 xs:text-sm sm:text-xl md:text-xl">Massage anti-stress (Trigger Point)</p>
